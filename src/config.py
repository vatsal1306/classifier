...
DESCRIPTION = "EfficientNet V2 Small SGD on manual filtered data"  # Description for the current run
RUN_NAME = "effnet_v2_s_sgd"  # Name for the current run (used in the run directory)
SAVE_CHECKPOINT_EPOCHS = 10  # Save a model checkpoint every N epochs
